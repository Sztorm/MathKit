...
class Vector2IArrayTests {
    ...
    fun allReturnsCorrectValue(
        array: Wrapper<Vector2IArray>, predicate: (Vector2I) -> Boolean, expected: Boolean
    ) = assertEquals(expected, array.value.all(predicate))

    @ParameterizedTest
    @MethodSource("anyArgs")
    fun anyReturnsCorrectValue(array: Wrapper<Vector2IArray>, expected: Boolean) =
    ...
    fun countReturnsCorrectValue(array: Wrapper<Vector2IArray>, expected: Int) =
    ...
    fun distinctReturnsCorrectValue(array: Wrapper<Vector2IArray>, expected: List<Vector2I>) =
        assertContentEquals(expected, array.value.distinct())

    @ParameterizedTest
    @MethodSource("distinctByArgs")
    fun <K> distinctByReturnsCorrectValue(
        array: Wrapper<Vector2IArray>, selector: (Vector2I) -> K, expected: List<Vector2I>
    ...
    fun randomOrNullReturnsCorrectValue(array: Wrapper<Vector2IArray>) {
        val randomOrNull: Vector2I? = assertDoesNotThrow {
    ...
    fun shuffleReturnsCorrectValue(array: Wrapper<Vector2IArray>) {
        assertDoesNotThrow {
    ...
    fun singleThrowsCorrectException(
        array: Wrapper<Vector2IArray>, expectedExceptionClass: Class<Throwable>
    ) {
        assertThrows(expectedExceptionClass) {
            array.value.single()
        }
    ...
    fun sliceThrowsCorrectException(
        array: Wrapper<Vector2IArray>, indices: IntRange, expectedExceptionClass: Class<Throwable>
    ) {
        assertThrows(expectedExceptionClass) {
    ...
    fun <C : MutableCollection<in Vector2I>> toCollectionReturnsCorrectValue(
        array: Wrapper<Vector2IArray>, destination: C, expected: C
    ...
    fun iterableSumReturnsCorrectValue(iterable: Iterable<Vector2I>, expected: Wrapper<Vector2I>) =
        assertEquals(expected.value, iterable.sum())

    @ParameterizedTest
    @MethodSource("iterableSumOfVector2IArgs")
    fun <T> iterableSumOfReturnsCorrectValue(
        iterable: Iterable<T>, selector: (T) -> Vector2I, expected: Wrapper<Vector2I>
    ) = assertEquals(expected.value, iterable.sumOf(selector))

    @Test
    fun vector2IArrayOfReturnsCorrectValue() =
        assertContentEquals(Vector2IArray(0), vector2IArrayOf())

    @ParameterizedTest
    @MethodSource("vector2IArrayOfVector2IArgs")
    fun vector2IArrayOfVector2IReturnsCorrectValue(
        element: Wrapper<Vector2I>, expected: Wrapper<Vector2IArray>
    ) = assertContentEquals(expected.value, vector2IArrayOf(element.value))

    @ParameterizedTest
    @MethodSource("vector2IArrayOfTypedArrayArgs")
    fun vector2IArrayOfTypedArrayReturnsCorrectValue(
        elements: Array<Vector2I>, expected: Wrapper<Vector2IArray>
    ) = assertContentEquals(expected.value, vector2IArrayOf(*elements))
    ...
    companion object {
        ...
        fun arrays(): List<Arguments> = listOf(
            ...
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(-3, 5), Vector2I(-1, 7))
                )
            ),
            Arguments.of(
        ...
        fun allArgs(): List<Arguments> = listOf(
            ...
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I.ZERO, Vector2I.ZERO, Vector2I(2, 1))
                ),
                { v: Vector2I -> v == Vector2I.ZERO },
                false
            ),
        ...
        fun copyOfRangeArgs(): List<Arguments> = listOf(
            ...
            Arguments.of(
                Wrapper(Vector2IArray(4) { Vector2I(it, 0) }),
                1, 3,
                Wrapper(vector2IArrayOf(Vector2I(1, 0), Vector2I(2, 0)))
            ),
        )
        ...
        fun countArgs(): List<Arguments> = listOf(
            Arguments.of(Wrapper(Vector2IArray(0)), 0),
            Arguments.of(Wrapper(Vector2IArray(3)), 3),
        )
        ...
        fun distinctArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(1, 2), Vector2I(1, 2), Vector2I(3, 4))
                ),
                listOf(Vector2I(1, 2), Vector2I(3, 4))
            ),
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(3, 4), Vector2I(1, 2), Vector2I(3, 4))
                ),
        ...
        fun distinctByArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(1, 2), Vector2I(2, 1), Vector2I(3, 4))
                ),
                { v: Vector2I -> Vector2I(min(v.x, v.y), max(v.x, v.y)) },
                listOf(Vector2I(1, 2), Vector2I(3, 4))
            ),
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(3, 4), Vector2I(1, 2), Vector2I(4, 3))
                ),
                { v: Vector2I -> Vector2I(min(v.x, v.y), max(v.x, v.y)) },
                listOf(Vector2I(3, 4), Vector2I(1, 2))
            ),
        ...
        fun firstArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I(4, 5), Vector2I(1, 2))),
        ...
        fun indexOfArgs(): List<Arguments> = listOf(
            ...
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I(4, 5), Vector2I(4, 5))),
                Wrapper(Vector2I(4, 5)),
                0
            ),
            Arguments.of(
        ...
        fun indexOfFirstArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(4, 5), Vector2I(1, 2), Vector2I(1, 2))
                ),
                { v: Vector2I -> v == Vector2I(1, 2) },
                1
            ),
        ...
        fun reverseArgs(): List<Arguments> = listOf(
            ...
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I(1, 2), Vector2I(3, 4))),
                Wrapper(vector2IArrayOf(Vector2I(3, 4), Vector2I(1, 2)))
            ),
        )
        ...
        fun singleArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I(1, 2))),
                Wrapper(Vector2I(1, 2))
            ),
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I.ZERO)),
                Wrapper(Vector2I(0, 0))
            ),
        )
        ...
        fun sliceArrayCollectionArgs(): List<Arguments> {
            ...
            return listOf(
                ...
                Arguments.of(
                    ...
                    listOf(0, 2),
                    Wrapper(
                        vector2IArrayOf(Vector2I(0, 0), Vector2I(2, 0))
                    ),
                ),
                Arguments.of(
                    Wrapper(array),
        ...
        fun sliceArrayRangeArgs(): List<Arguments> {
            ...
            return listOf(
                ...
                Arguments.of(
                    ...
                    1..2,
                    Wrapper(
                        vector2IArrayOf(Vector2I(1, 0), Vector2I(2, 0))
                    ),
                ),
                Arguments.of(
                    Wrapper(array),
        ...
        fun toCollectionArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(Vector2IArray(0)),
                mutableListOf<Vector2I>(),
                mutableListOf<Vector2I>(),
            ),
            Arguments.of(
                Wrapper(
                    vector2IArrayOf(Vector2I(0, 1), Vector2I(2, 3), Vector2I(4, 5))
                ),
                mutableListOf<Vector2I>(),
                mutableListOf(
                    Vector2I(0, 1), Vector2I(2, 3), Vector2I(4, 5)
                ),
            ),
            Arguments.of(
                Wrapper(
                ...
                mutableListOf(Vector2I(1, 1), Vector2I(2, 2)),
                mutableListOf(
                    Vector2I(1, 1),
                    Vector2I(2, 2),
                    Vector2I(0, 1),
        ...
        fun arrayPlusCollectionArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(Vector2IArray(0)),
                listOf(Vector2I(1, 0)),
                Wrapper(vector2IArrayOf(Vector2I(1, 0))),
            ),
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I(1, 0), Vector2I(2, 0))),
        ...
        fun arrayPlusVector2IArgs(): List<Arguments> = listOf(
            ...
            Arguments.of(
                ...
                Wrapper(
                    vector2IArrayOf(Vector2I(1, 0), Vector2I(2, 0), Vector2I(3, 0))
                ),
            ),
        )
        ...
        fun arrayPlusArrayArgs(): List<Arguments> = listOf(
            ...
            Arguments.of(
                Wrapper(vector2IArrayOf(Vector2I(1, 0), Vector2I(2, 0))),
                Wrapper(vector2IArrayOf(Vector2I(3, 0), Vector2I(4, 0))),
                Wrapper(
                    vector2IArrayOf(
                        Vector2I(1, 0),
                        Vector2I(2, 0),
        ...
        fun setArgs(): List<Arguments> = listOf(
            Arguments.of(
                ...
                Wrapper(Vector2I(1, 0)),
                Wrapper(
                    vector2IArrayOf(Vector2I(1, 0), Vector2I.ZERO, Vector2I.ZERO, Vector2I.ZERO)
                ),
            ),
            Arguments.of(
                Wrapper(Vector2IArray(4) { Vector2I.ZERO }),
                ...
                Wrapper(
                    vector2IArrayOf(Vector2I.ZERO, Vector2I.ZERO, Vector2I.ZERO, Vector2I(3, 4))
                )
            ),
        )
        ...
        fun typedArraySumArgs(): List<Arguments> = listOf(
            Arguments.of(emptyArray<Vector2I>(), Wrapper(Vector2I.ZERO)),
            Arguments.of(
                arrayOf(
                    Vector2I(1, 2), Vector2I(-2, -1), Vector2I(10, 10)
                ),
        ...
        @JvmStatic
        fun typedArraySumOfVector2IArgs(): List<Arguments> = listOf(
            Arguments.of(
                arrayOf(
                    Vector2I(1, 2), Vector2I(-2, -1), Vector2I(10, 10)
                ),
        ...
        fun iterableSumArgs(): List<Arguments> = listOf(
            Arguments.of(emptyList<Vector2I>(), Wrapper(Vector2I.ZERO)),
            Arguments.of(
                listOf(
                    Vector2I(1, 2), Vector2I(-2, -1), Vector2I(10, 10)
                ),
        ...
        @JvmStatic
        fun iterableSumOfVector2IArgs(): List<Arguments> = listOf(
            Arguments.of(
                listOf(
                    Vector2I(1, 2), Vector2I(-2, -1), Vector2I(10, 10)
                ),
        ...
        @JvmStatic
        fun vector2IArrayOfVector2IArgs(): List<Arguments> = listOf(
            Arguments.of(
                Wrapper(Vector2I(3, 4)),
                Wrapper(arrayOf(Vector2I(3, 4)).toVector2IArray())
            ),
            Arguments.of(
                Wrapper(Vector2I(-2, -1)),
                Wrapper(arrayOf(Vector2I(-2, -1)).toVector2IArray())
            ),
        )

        @JvmStatic
        fun vector2IArrayOfTypedArrayArgs(): List<Arguments> = listOf(
            Arguments.of(
                emptyArray<Vector2I>(),
                Wrapper(emptyArray<Vector2I>().toVector2IArray())
            ),
            Arguments.of(
                arrayOf(Vector2I(1, 2)),
                Wrapper(arrayOf(Vector2I(1, 2)).toVector2IArray())
            ),
            Arguments.of(
                arrayOf(Vector2I(1, 2), Vector2I(-2, -1)),
                Wrapper(
                    arrayOf(Vector2I(1, 2), Vector2I(-2, -1))
                        .toVector2IArray()
                )
